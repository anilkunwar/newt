...
/**
 * CompositeConductivityTensor provides a simple RealTensorValue type
 ...
 */
class CompositeConductivityTensor : public CompositeTensorBase<RealTensorValue, Material>
{
public:
  static InputParameters validParams();

  CompositeConductivityTensor(const InputParameters & parameters);
