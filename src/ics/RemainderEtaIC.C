...
RemainderEtaIC::RemainderEtaIC(const InputParameters & parameters)
...
RemainderEtaIC::~RemainderEtaIC() {}

Real
RemainderEtaIC::value(const Point & p)
{
