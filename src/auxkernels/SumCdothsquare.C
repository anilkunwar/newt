...
#include "SumCdothsquare.h"

registerMooseObject("newtApp", SumCdothsquare);

template <>
InputParameters
validParams<SumCdothsquare>()
{
...
SumCdothsquare::SumCdothsquare(const InputParameters & parameters)
...
SumCdothsquare::computeValue()
{
  ...
  return _var1[_qp]*(_prop_h1[_qp]*_prop_h1[_qp]+_prop_h2[_qp]*_prop_h2[_qp]+_prop_h3[_qp]*_prop_h3[_qp]) ;
}
