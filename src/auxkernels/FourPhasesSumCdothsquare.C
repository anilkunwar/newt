...
registerMooseObject("newtApp", FourPhasesSumCdothsquare);

template <>
InputParameters
validParams<FourPhasesSumCdothsquare>()
{
  ...
  params.addRequiredParam<MaterialPropertyName>("h3_name","Switching function of al");
  params.addRequiredParam<MaterialPropertyName>("h4_name","Switching function of ni");
...
FourPhasesSumCdothsquare::computeValue()
{
  ...
  return _var1[_qp]*(_prop_h1[_qp]*_prop_h1[_qp]+_prop_h2[_qp]*_prop_h2[_qp]+_prop_h3[_qp]*_prop_h3[_qp]+_prop_h4[_qp]*_prop_h4[_qp]+_prop_h5[_qp]*_prop_h5[_qp]) ;
}
